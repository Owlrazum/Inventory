...
public static class CustomMath
{
    ...
    /// <summary>
    /// angle360 is eq to 0 for x = -1, y = 0, 90 for x = 0, y = 1;
    /// </summary>
    public static float ConvertAtan2AngleTo360(float atan2Angle)
    {
        return 180 - atan2Angle * Mathf.Rad2Deg; 
    }

    /// <summary>
    /// angle360 is eq to 0 for x = -1, y = 0, 90 for x = 0, y = 1;
    /// </summary>
    public static float ConvertAngle360ToAtan2(float angle360)
    {
        return (180 - angle360) * Mathf.Deg2Rad;
    }
    #endregion
    ...
    public static float GetPointLineDistanceByProjection(Vector3 point, Vector3 lineStart, Vector3 lineEnd)
    {
        return (point - ProjectPoint(point, lineStart, lineEnd)).magnitude;
    }
    ...
    public static float Cotangent(float angleRad)
    {
        return Mathf.Cos(angleRad) / Mathf.Sin(angleRad);
    }

    #region PointOnCircle

    /// <summary>
    /// The first axis denotes Cos, the second Sin;
    /// </summary>
    public static Vector3 ComputePointOnCircleXZ(float radius, float radian)
    {
    ...
    /// The first axis denotes Cos, the second Sin;
    /// </summary>
    public static Vector3 ComputePointOnCircleZY(float radius, float radian)
    { 
        Vector3 normalizedPoint =
            new Vector3(0, Mathf.Sin(radian), Mathf.Cos(radian));
        return normalizedPoint * radius;
    }
    ...
    /// The first axis denotes Cos, the second Sin;
    /// </summary>
    public static Vector3 ComputePointOnCircleXY(float radius, float radian)
    { 
        Vector3 normalizedPoint =
